            ...
            <Route
              ...
              render={props => (
                <>
                  ...
                  />
                  <Wrapper>
                    <Main {...props} user={user} apiURL={apiURL} />
                  </Wrapper>
            ...
            <Route
              ...
              render={props => (
                <>
                  ...
                  />
                  <Wrapper>
                    <Login {...props} user={user} apiURL={apiURL} />
                  </Wrapper>
                  {!this.state.showFooterBar ||
                  (Object.keys(user).length === 0 &&
                    user.constructor === Object) ? null : (
            ...
            <Route
              ...
              render={props => (
                <>
                  ...
                  />
                  <Wrapper>
                    <Signup {...props} user={user} apiURL={apiURL} />
                  </Wrapper>
                  {!this.state.showFooterBar ||
                  (Object.keys(user).length === 0 &&
                    user.constructor === Object) ? null : (
            ...
            <Route
              ...
              render={props => (
                <>
                  ...
                  />
                  <Wrapper>
                    <Dashboard {...props} user={user} apiURL={apiURL} />
                  </Wrapper>
                  {!this.state.showFooterBar ||
                  (Object.keys(user).length === 0 &&
                    user.constructor === Object) ? null : (
            ...
            <Route
              render={props => (
                <>
                  ...
                  />
                  <Wrapper>
                    <PageNotFound {...props} user={user} apiURL={apiURL} />
                  </Wrapper>
                </>
              )}
            />
